...
public class Imshow {
	...
	public Imshow(String title) {
		// Window = new JFrame();
		Window = new FrameTracking();
		image = new ImageIcon();
		FrameLabel = new JLabel();
		// matOfByte = new MatOfByte();
		FrameLabel.setIcon(image);


		Window.getContentPane().add(FrameLabel);
	...
	public boolean showImage(Mat img) {
